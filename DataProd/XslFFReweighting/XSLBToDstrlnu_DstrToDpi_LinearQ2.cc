...
#include "XslFFReweighting/XSLBToDstrlnu_DstrToDpi_LinearQ2.hh"
...
XSLBToDstrlnu_DstrToDpi_LinearQ2::XSLBToDstrlnu_DstrToDpi_LinearQ2( HepLorentzVector BLab, HepLorentzVector LepLab, 
...
XSLBToDstrlnu_DstrToDpi_LinearQ2::FromSP4ToThisModel()
{
  ...
  XSLEvtFFWeight* D = new XSLBToDstrlnu_DstrToDpi_LinearQ2(_mB, _mDStar, _q2, _ctl, _ctv, _chi, R1, R2, rho2);
