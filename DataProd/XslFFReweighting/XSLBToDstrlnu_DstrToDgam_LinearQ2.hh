...
#ifndef XSLBTODSTRLNU_DSTRTODGAM_LINEARQ2
#define XSLBTODSTRLNU_DSTRTODGAM_LINEARQ2
...
class XSLBToDstrlnu_DstrToDgam_LinearQ2 : public XSLEvtFFWeight {
public:
  XSLBToDstrlnu_DstrToDgam_LinearQ2(double mB, double mDStar, double q2, double ctl, double ctv, double chi, double R1, double R2, double rho2);
  XSLBToDstrlnu_DstrToDgam_LinearQ2(HepLorentzVector BLab, HepLorentzVector LepLab, HepLorentzVector DStarLab, HepLorentzVector DStarDaugLab, 
			    double R1, double R2, double rho2);
  XSLBToDstrlnu_DstrToDgam_LinearQ2( XSLKin* DecayKin, double R1, double R2, double rho2 );
  virtual ~XSLBToDstrlnu_DstrToDgam_LinearQ2();
